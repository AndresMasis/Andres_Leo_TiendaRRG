...
import tiendarpg.Personaje;
import tiendarpg.Items;
...
public class ProgramaInicio {
    public void ProgramaInicio2() throws IOException, UnirestException{
    ...
    System.out.println("Precio: "+ pre.listPrecio[0] +"\n Review:"+pre.listReviews[0]);
    ...
    do{
        ...
        switch(opcion){
            case 1:
                tienda(todos_objetos, character,in);
                break;
            case 2:
                inventario(in, character);
                break;
            case 3:
                equipados(character,in);
                break;
            case 4:
                verStats(character);
                break;
    ...
    public void tienda(LinkedList<Items> todos_objetos, Personaje character, Scanner in){
        do {
    ...
    public void inventario(Scanner in, Personaje character){
        do {
    ...
    public void equipados( Personaje character,Scanner in){
        do {
    ...
    public void verStats(Personaje character){
